...
export const metadata = {
  openGraph: {
    ...
    images: [
      {
        url: "https://www.amitshuu.com/laptop.png",
        width: 1200,
        height: 630,
  ...
  keywords: [
    "Amit Shukrun, amitshuu, Shukrun, מפתח אתרים, דפי נחיתה, Web development, Full-stack development, Landing page design, Website design, Shopify development, Website maintenance, Custom web applications, Web design services, עמית שוקרון, שוקרון",
  ],
  title: "Amit Shukrun - Web Developer | עמית שוקרון - מפתח אתרים",
  description:
    "I'm Amit Shukrun, a fullstack web developer offering landing page creation, web app development, Shopify ecommerce and more. Let's build your website!",
